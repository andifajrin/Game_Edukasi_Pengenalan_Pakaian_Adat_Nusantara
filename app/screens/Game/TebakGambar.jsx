...
import { View, Text, SafeAreaView, StatusBar, Image, TouchableOpacity, Modal, Animated, ScrollView, ImageBackground } from "react-native";
import { COLORS, SIZES } from "../../constants";
import data from "../../data/TebakGambarData";
import MaterialCommunityIcons from "react-native-vector-icons/MaterialCommunityIcons";
import db from "../../db/config";

const TebakGambar = ({ navigation, route }) => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {allQuestions[currentQuestionIndex]?.penjelasan}
          </Text>
        </View>
      </View>
    );
  ...
  const renderNextButton = () => {
    if (showNextButton) {
      return (
        ...
        >
          <Text style={{ fontSize: 20, color: COLORS.white, textAlign: "center" }}>Selanjutnya</Text>
        </TouchableOpacity>
      );
    } else {
      return null;
